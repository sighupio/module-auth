...
| ----------- | ---------------------------------------------------------------------- | ---------------- |
| `dex`       | [`v2.45.1`](https://github.com/dexidp/dex/releases/tag/v2.44.0)        | `v2.44.0`        |
| `gangplank` | [`v1.2.0`](https://github.com/sighupio/gangplank/releases/tag/v1.1.1)  | `v1.1.1`        |
| `pomerium`  | [`v0.32.7`](https://github.com/pomerium/pomerium/releases/tag/v0.31.1) | `v0.31.1`        |
